...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Revisión de plantilla por coordinador. Cada revisión genera un nuevo registro.';
...
INSERT INTO `aprobacion` VALUES (1,1,4,'APROBADA','','2026-04-06 15:15:57');
...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Registro de asistencia a evento. Existencia del registro = asistió.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `asistencia` VALUES (3,1,1,'2026-04-07 15:42:41');
...
INSERT INTO `auxiliar_evento` VALUES (4,1,'2026-03-31 16:14:41'),(6,1,'2026-04-09 17:07:19'),(8,4,'2026-04-30 03:47:16'),(11,4,'2026-04-30 03:51:34'),(13,1,'2026-04-30 08:47:00'),(18,1,'2026-04-28 15:35:27'),(25,4,'2026-04-30 03:52:25'),(25,5,'2026-04-30 04:05:47'),(25,7,'2026-04-30 04:06:06');
...
INSERT INTO `carrera` VALUES (1,'Historia','ACTIVA'),(2,'Filosofía','ACTIVA'),(3,'Turismo','ACTIVA'),(4,'Literatura','ACTIVA'),(5,'Psicología','ACTIVA'),(6,'Lingüística e Idiomas','ACTIVA'),(7,'Ciencias de la Educación','ACTIVA'),(8,'Ciencias de la Información','ACTIVA'),(9,'Nueva Carrera de Prueba','INACTIVA');
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Certificado digital emitido. Control de versiones para anulaciones y reemisiones.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `certificado` VALUES (1,2,'93b4eb3b-fb9c-4cf8-b26a-53b0ba1f5076','certificados\\cert_1_v1.pdf','GENERADO',1,'2026-04-06 15:20:54');
...
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Códigos de 6 dígitos para verificar email de usuarios externos';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Cursos complementarios. Certificación por aprobación de nota.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Eventos facultativos. Certificación por asistencia.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Inscripción de un participante a un curso o evento';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Transacción de pago asociada a una inscripción';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `paralelo` VALUES (1,'A',6,'PRESENCIAL',30,'Lunes y miércoles 08:00 - 10:00','https://meet.google.com/abc-123'),(1,'B',4,'VIRTUAL',50,'','https://meet.google.com/abc-defg-hij'),(3,'A',14,'PRESENCIAL',50,'Miercoles 12:00 - 14:00',''),(4,'A',14,'PRESENCIAL',30,'Jueves 18:00-20:00',''),(5,'A',6,'PRESENCIAL',20,'Lunes a Viernes, 20:00-21:00',''),(6,'A',14,'PRESENCIAL',30,'Lunes 14:00-16:00',''),(7,'A',14,'PRESENCIAL',20,'Miercoles 15:00-17:00',''),(8,'A',4,'PRESENCIAL',40,'lu',''),(9,'A',6,'MIXTO',50,'Lunes y Martes, 18:00 - 20:00',''),(10,'A',6,'PRESENCIAL',10,'Martes y Jueves, 10:00 - 12:00',''),(11,'A',14,'PRESENCIAL',30,'Viernes 14:00 - 16:00','');
...
INSERT INTO `participante` VALUES (4,'EXTERNO'),(5,'EXTERNO'),(6,'EXTERNO'),(7,'EXTERNO'),(8,'EXTERNO'),(11,'EXTERNO'),(13,'EXTERNO'),(14,'EXTERNO'),(15,'EXTERNO'),(16,'EXTERNO'),(18,'EXTERNO'),(24,'EXTERNO'),(25,'EXTERNO'),(26,'EXTERNO'),(27,'EXTERNO');
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Plantilla PDF para certificados. Solo una VIGENTE por actividad.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `plantilla_certificado` VALUES (1,1,NULL,'C:\\Users\\kbre1\\Documents\\INFORMATICA\\sistema-cursos-fhce\\plantillas\\plantilla_curso_1_v1_0d813633.pdf',1,6,'2026-04-06 15:03:36','VIGENTE');
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Generada cuando el docente confirma notas. Flujo: PENDIENTE→EN_PROCESO→COMPLETADO';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `solicitud_emision` VALUES (1,1,'A',NULL,4,2,'EN_PROCESO',4,'2026-03-31 15:27:23','2026-03-31 15:28:15','Todos los estudiantes completaron el curso satisfactoriamente');
...
CREATE TABLE `usuario` (
  ...
  KEY `idx_estado` (`estado`)
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Entidad base de la jerarquía de usuarios';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `usuario_rol` VALUES (1,1,'2026-03-23 02:27:30',NULL),(4,2,'2026-03-24 20:21:43',NULL),(4,3,'2026-03-24 20:33:57',NULL),(4,4,'2026-03-23 05:04:58',NULL),(4,5,'2026-03-31 20:03:50',NULL),(5,4,'2026-03-24 16:09:55',NULL),(6,3,'2026-04-06 21:24:40',1),(6,4,'2026-03-31 20:19:29',NULL),(6,5,'2026-03-31 20:21:23',NULL),(6,6,'2026-04-06 18:35:29',NULL),(7,3,'2026-04-09 20:40:58',4),(7,4,'2026-04-06 20:31:54',NULL),(8,4,'2026-04-13 19:27:51',NULL),(8,5,'2026-04-30 07:47:15',4),(11,4,'2026-04-13 19:45:02',NULL),(11,5,'2026-04-30 07:51:33',4),(13,4,'2026-04-14 13:37:38',NULL),(13,5,'2026-04-30 12:46:59',4),(14,3,'2026-04-16 15:28:18',4),(14,4,'2026-04-14 13:47:02',NULL),(15,4,'2026-04-14 14:41:17',NULL),(16,4,'2026-04-14 19:18:10',NULL),(18,2,'2026-04-28 19:33:50',1),(18,4,'2026-04-28 17:08:40',NULL),(18,5,'2026-04-28 19:35:25',4),(24,4,'2026-04-28 21:21:19',NULL),(25,4,'2026-04-30 06:38:22',NULL),(25,5,'2026-04-30 07:52:24',4),(26,4,'2026-04-30 07:27:12',NULL),(27,4,'2026-04-30 07:31:37',NULL);
...
-- Dump completed on 2026-05-06 16:41:03
